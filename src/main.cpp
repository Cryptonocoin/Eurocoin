...
uint256 hashGenesisBlock("0x4628bcd8d460835c991e66faf7f66b1b27150140b591f5b928d06318e2170914");
...
const string strMessageMagic = "EuroCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 50 * COIN;
		if(nHeight < 21)
       		 nSubsidy = 370000 * COIN;
		nSubsidy >>= (nHeight / 200000); // EuroCoin: 200k blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eurocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EuroCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x789485a1f7654d5fbecc76e3ec315a9d502fe6d55a43569477e9d13a9a24c4c1");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "each of us is a part of the system";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394885382; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1013743;

        if (fTestNet)
        {
            block.nTime    = 1393722000;
            block.nNonce   = 1167064;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3feb221c560f580497855fa0a14cfa8cab855c06c0bf4a23a22f61a8d6f12ac1"));
